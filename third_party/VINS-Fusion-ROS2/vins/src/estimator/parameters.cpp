...
int MAX_CNT;
int MIN_DIST;
int USE_SUPERPOINT = 0;   // ARGUS C2: default OFF -> C1 (KLT/Harris) behaviour unchanged
double F_THRESHOLD;
int SHOW_TRACK;
int FLOW_BACK;
...
void readParameters(std::string config_file)
{
    ...
    // ARGUS C2: optional key; absent in C1 baseline config -> stays 0 (KLT/Harris).
    if (!fsSettings["use_superpoint"].isNone())
        USE_SUPERPOINT = (int)fsSettings["use_superpoint"];
